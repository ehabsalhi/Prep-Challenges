...
const cvsFiltration = (arr) => {
    ...
    let arr2 = arr.filter (ele =>
        ele.yearsOfExperience > 4 && ele.tech === "JS"
    ) 

    let arr3 = arr2.map(ele => {
            let obj = {
                    fullName : `${ele.firstName != null ? ele.firstName : ""} ${ele.LastName != null ? ele.LastName :"" }`,
                    tech : "JS"
            }
            return obj
    })
