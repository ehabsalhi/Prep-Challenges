...
const LastWord = (str) => {
    ...
    return (str.slice(str.includes(" ") ? str.lastIndexOf(" ") + 1 : str.indexOf(""), ));
...
const replaceWords = (str) => {
    ...
    if (newStr.includes("I") )   { newStr.splice(newStr.indexOf("I") , 1 , "We")}
    if (newStr.includes("am") )  {  newStr.splice(newStr.indexOf("am") , 1 , "are") }
    if (newStr.includes("was") ) {  newStr.splice(newStr.indexOf("was") , 1 , "were") }
