...
const filterLinks = (str) => {
    // write your code here
    let paraRE = /www.\w+.(com|org|net)/ig
    return str.match(paraRE)[0]
}
// -------------------------------------------------------------------------------------------------------
...
const isPalindrome = (s) => {
        // write your code here
        let lowCase =  s.toLocaleLowerCase()
        let replace = lowCase.replace(/[^0-9a-z]/gi,"")
        let arr = []
        
        for(let i = 0 ; i < replace.length / 2  ; i++){
